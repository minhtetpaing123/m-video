...
<div class="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-700/50 overflow-visible flex flex-col justify-between h-full {{ $layoutMode === 'grid' ? 'mb-0' : 'mb-4' }}"
     wire:key="post-card-{{ $post->id }}"
     x-data="{ isVisible: true }"
     x-show="isVisible">
    
    <div>
        {{-- Post Header (z-40 ကို ဖြုတ်လိုက်ပါသည်) --}}
