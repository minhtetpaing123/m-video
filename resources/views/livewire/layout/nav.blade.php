...
<div class="mv-bottom-nav">
    <a href="{{ route('dashboard') }}" wire:navigate class="mv-nav-item {{ $active === 'home' ? 'active' : '' }}">
    ...
    <a href="/friends" wire:navigate class="mv-nav-item {{ $active === 'friends' ? 'active' : '' }}">
        <div class="mv-nav-icon">
            <svg viewBox="0 0 28 28" height="24" width="24" fill="currentColor">
    ...
    <a href="/watch" wire:navigate class="mv-nav-item {{ $active === 'watch' ? 'active' : '' }}">
        <div class="mv-nav-icon">
            <svg viewBox="0 0 28 28" height="24" width="24" fill="currentColor">
    ...
    <a href="{{ route('noti') }}" wire:navigate class="mv-nav-item {{ $active === 'notifications' ? 'active' : '' }}">
        <div class="mv-nav-icon">
            <svg viewBox="0 0 28 28" height="24" width="24" fill="currentColor">
    ...
    {{-- Profile Link --}}
    <a href="{{ route('profile.show', auth()->user()) }}" wire:navigate class="mv-nav-item {{ $active === 'profile' ? 'active' : '' }}">
        <div class="mv-nav-icon">
            <svg viewBox="0 0 28 28" height="24" width="24" fill="currentColor">
...
.mv-nav-item.active .mv-nav-label {
    color: #2d88ff;
}
...
.mv-notification-badge {
    ...
    justify-content: center;
    padding: 0 4px;
    border: 2px solid var(--nav-bg, #1a1a2e);
